...
*/
   ...
   function validarNumber(nodo){ // compruebo si lo que hay en el campo NO ES UN NUMBER
    if (isNaN(nodo.value)){  // nodo es el campo input entero con todas sus atributos y caract.
        ...
        nodo.style.borderColor="red"; //en el estilo del propio nodo, cambio el borde 
      }
   }
